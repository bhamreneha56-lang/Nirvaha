    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <header className="p-4 flex justify-between items-center bg-white shadow" style={{ borderTop: `4px solid ${theme.colors.primary}` }}>
        ...
        <div className="flex items-center gap-4">
          ...
          <button onClick={onLogout} className="text-sm text-gray-600 underline">Logout</button>
        </div>
      </header>
      ...
      <main className="p-4 max-w-4xl mx-auto mt-6">
        <div className="mb-6 flex justify-between items-end">
          <div>
            ...
            <p className="text-gray-600">Track your submissions and community impact.</p>
          </div>
          <button
        ...
        <section className="bg-white rounded shadow p-4">
          ...
          {problems.length === 0 ? (
            <p className="text-gray-500 py-4 text-center">No problems reported yet.</p>
          ) : (
              ...
              {problems.map(p => (
                <div key={p._id} className="border p-4 rounded flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{p.problemIdReadable} • {p.category}</p>
                  </div>
