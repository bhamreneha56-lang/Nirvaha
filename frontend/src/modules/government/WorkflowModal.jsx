...
export default function WorkflowModal() {
    ...
    switch (activeWorkflow.action) {
      case 'VERIFY_EVIDENCE':
        return (
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-black uppercase tracking-widest mb-1.5">Decision</label>
              <select 
                className="w-full bg-white border border-blue-100 rounded-lg p-3 text-sm font-medium text-black focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div>
              <label className="block text-xs font-bold text-black uppercase tracking-widest mb-1.5">Verification Remarks (Requiorange)</label>
              <textarea 
                required
                rows={3}
      ...
      case 'ASSIGN_OFFICER':
        return (
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-black uppercase tracking-widest mb-1.5">Select Officer</label>
              <select 
                className="w-full bg-white border border-blue-100 rounded-lg p-3 text-sm font-medium text-black focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div>
              <label className="block text-xs font-bold text-black uppercase tracking-widest mb-1.5">SLA / Expected Response Time</label>
              <select 
                className="w-full bg-white border border-blue-100 rounded-lg p-3 text-sm font-medium text-black focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      case 'OVERRIDE_AI':
        return (
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold text-black uppercase tracking-widest mb-1.5">New Priority Score (1-100)</label>
              <input 
                type="number"
                min="1" max="100"
                required
            ...
            <div>
              <label className="block text-xs font-bold text-black uppercase tracking-widest mb-1.5">Reason for Override (Requiorange)</label>
              <textarea 
                required
                rows={3}
      ...
      case 'CREATE_MASTER_CHALLENGE':
        return (
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold text-black uppercase tracking-widest mb-1.5">Challenge Title</label>
              <input 
                type="text"
                required
            ...
            <div>
              <label className="block text-xs font-bold text-black uppercase tracking-widest mb-1.5">Affected Location</label>
              <input 
                type="text"
                required
      ...
      case 'INVITE_UNIVERSITY':
        return (
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-black uppercase tracking-widest mb-1.5">Select Institution</label>
              <select 
                required
                className="w-full bg-white border border-blue-100 rounded-lg p-3 text-sm font-medium text-black focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
            ...
            <div>
              <label className="block text-xs font-bold text-black uppercase tracking-widest mb-1.5">Response Deadline</label>
              <input 
                type="date"
                required
                className="w-full bg-white border border-blue-100 rounded-lg p-3 text-sm font-medium text-black focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      case 'START_AI_ANALYSIS':
        return (
          <div className="space-y-4">
            <div className="bg-blue-200 text-blue-600 p-3 rounded-lg text-xs font-medium border border-blue-300">
      ...
      case 'REJECT_CASE':
        return (
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-black uppercase tracking-widest mb-1.5">Reason for Rejection (Requiorange)</label>
              <textarea 
                required
                rows={3}
                className="w-full bg-white border border-blue-100 rounded-lg p-3 text-sm font-medium text-black focus:outline-none focus:ring-2 focus:ring-orange-500"
                value={formData.reason}
                onChange={e => setFormData({...formData, reason: e.target.value})}
              />
            </div>
      ...
      case 'ESCALATE_CASE':
        return (
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-black uppercase tracking-widest mb-1.5">Escalation Reason (Requiorange)</label>
              <textarea 
                required
                rows={3}
      ...
      case 'SUBMIT_RESOLUTION':
        return (
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-black uppercase tracking-widest mb-1.5">Resolution Remarks (Requiorange)</label>
              <textarea 
                required
                rows={3}
                placeholder="Describe the actions taken to resolve this issue."
                className="w-full bg-white border border-blue-100 rounded-lg p-3 text-sm font-medium text-black focus:outline-none focus:ring-2 focus:ring-green-500"
                value={formData.remarks}
                onChange={e => setFormData({...formData, remarks: e.target.value})}
              />
            </div>
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 bg-blue-600/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
        <motion.div 
        ...
        >
          <div className="bg-white border-b border-blue-100 px-6 py-4 flex justify-between items-center text-black">
            ...
            <button onClick={handleClose} className="text-black hover:text-black transition-colors">
              <X size={20} />
            </button>
          </div>
          
          <form onSubmit={handleSubmit} className="p-6 flex-1 overflow-y-auto">
            <div className="text-xs font-bold text-black uppercase tracking-widest mb-6 pb-2 border-b border-blue-100 flex items-center gap-2">
            ...
            <div className="mt-8 pt-4 border-t border-blue-100 flex justify-end gap-3">
              <button 
                type="button" 
                onClick={handleClose}
                className="px-5 py-2.5 rounded-lg text-sm font-bold text-black hover:bg-white transition-colors"
              >
                Cancel
              </button>
              <button 
                type="submit"
                className="bg-blue-600 hover:bg-blue-600 text-white px-5 py-2.5 rounded-lg text-sm font-bold shadow-md transition-colors flex items-center gap-2"
              >
