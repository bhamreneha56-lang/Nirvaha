...
import { university, problems, activityFeed, projects, faculty, students, getSuccessBg, getPriorityColor } from "@/lib/mockData";
    ...
    <div className="space-y-6">
            ...
            >
              <div className="flex flex-wrap items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <Link href={`/university/challenges/${p.id}`} className="group">
                ...
                <div className="flex flex-col sm:flex-row lg:flex-col gap-2 flex-shrink-0 pt-1">
                  {accepted.includes(p.id) ? (
                    ...
                    <>
                      <Link
                        href={`/university/challenges/${p.id}`}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm col-span-2 lg:col-span-1">
          ...
          <Link href="/university/projects" className="text-xs text-indigo-600 font-semibold flex items-center gap-1 mt-3 hover:underline">View all <ChevronRight size={12}/></Link>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
          ...
          <Link href="/university/proposals/new" className="text-xs text-green-600 font-semibold flex items-center gap-1 mt-3 hover:underline">New proposal <ChevronRight size={12}/></Link>
        </div>
      </div>
