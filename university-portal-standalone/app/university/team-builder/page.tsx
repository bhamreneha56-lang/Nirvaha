...
import { faculty, students, problems } from "@/lib/mockData";
    ...
    <div className="space-y-5">
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <div className="space-y-4">
          ...
          {saved && (
            <Link href="/university/proposals/new" className="block text-center text-sm text-indigo-600 font-semibold hover:underline">Continue to Proposal Draft →</Link>
          )}
        </div>
      </div>
    </div>
